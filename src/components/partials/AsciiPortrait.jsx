...
const AsciiPortrait = () => {
  ...
  useEffect(() => {
    ...
    const parchment = styles.getPropertyValue("--bs-parchment").trim();
    const lavenderPurple = styles.getPropertyValue("--bs-lavender-purple").trim();
    ...
    const draw = () => {
      ...
      particles.forEach((p) => {
        ...
        ctx.shadowColor = lavenderPurple;
        ctx.shadowBlur = 20;
